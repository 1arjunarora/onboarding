...
if st.button('Click Here To Generate Personalized Onboarding Plan & Recommendations Based On Your Role, Team and Goals'):  
    st.write('1. Orientation: On 7/12, please report to the SF office for your formal orientation. You will receive your employee ID, complete any required paperwork, and meet the HR director 2. Team Introduction - Once you've settled in, we will arrange a team meeting where you can meet your colleagues and get acquainted with everyone. It's a great opportunity to learn about ongoing projects, team dynamics, and individual responsibilities. 3. Equipment and Access: Our IT team will provide you with the necessary equipment, such as a laptop, software tools, and access credentials. If you have any specific requirements or preferences, please let us know in advance. 4. Onboarding Buddy: To help you navigate your first few weeks, we have assigned [Buddy's Name] as your onboarding buddy. [Buddy's Name] will be your go-to person for any questions, guidance, or assistance you may need. They will introduce you to our processes, tools, and answer any queries you may have. 5. Training and Development: We are committed to your professional growth. As part of your onboarding, we have planned training sessions and mentorship opportunities tailored to your role. You will have the chance to enhance your skills and contribute to challenging projects. 6. Communication Channels: We utilize various communication tools such as Slack, email, and project management software. We encourage open communication, collaboration, and knowledge sharing across the team. Please familiarize yourself with our communication channels and join relevant groups. 7. Company Culture: At [Company Name], we take pride in our inclusive and supportive work culture. We value diversity, respect different perspectives, and foster a collaborative environment. Feel free to explore our company values, policies, and any upcoming team events.')
